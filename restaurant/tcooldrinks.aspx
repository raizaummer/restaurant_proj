<%@ Page Title="" Language="C#" MasterPageFile="~/Traditionalrest.Master" AutoEventWireup="true" CodeBehind="tcooldrinks.aspx.cs" Inherits="restaurant.WebForm18" %>
...
<div>  <asp:Label ID="Label1" runat="server" Text="Label" Visible="False" ForeColor="#CC0000"></asp:Label></div>                 
 ...
 <asp:Button ID="Button1" runat="server" Text="Payment" onclick="Button1_Click"/>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server"
           ...
           SelectCommand="select prid,image,pname,detail,category,price,productqty from product where category='Cool Drinks' and productqty>0"
